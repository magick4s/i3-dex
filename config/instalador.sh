...
echo -e "\e[33m\e[1m==> \e[39m\e[1mOlá "$USER"."

echo -e "\e[33m\e[1m==> \e[39m\e[1mInstalando pacotes essenciais"
...
echo -e "\e[33m\e[1m==> \e[39m\e[1mHabilitando serviços"
	sudo systemctl enable dhcpcd.service
	sudo systemctl start dhcpcd
	sudo systemctl enable NetworkManager.service
	sudo systemctl start NetworkManager

echo -e "\e[33m\e[1m==> \e[39m\e[1mCriando diretórios"
...
echo -e "\e[33m\e[1m==> \e[39m\e[1mBaixando I3 Dex"
	cd $HOME/GitHub
	sudo rm -dR i3-dex
	git clone https://github.com/jirrezdex/i3-dex.git | exit
	cd i3-dex/config

echo -e "\e[33m\e[1m==> \e[39m\e[1mFornecendo permissões"
	chmod +x *
	chmod +x desenvolvedor/*
	chmod +x scripts/*

echo -e "\e[33m\e[1m==> \e[39m\e[1mMedidas de segurança"
...
echo -e "\e[33m\e[1m==> \e[39m\e[1mInstalando configuração"
...
echo -e "\e[33m\e[1m==> \e[39m\e[1mDeseja instalar os pacotes extras?"
...
echo -e "\e[33m\e[1m==> \e[39m\e[1mRemover configuração do desenvolvedor? RECOMENDADO PARA TOTAL FUNCIONAMENTO!"
if pergunta "S - Para sim || N - Para não ----" S; then
	sudo rm -dR .config/desenvolvedor
fi

echo -e "\e[33m\e[1m==> \e[39m\e[1mFinalizando"
