...
echo -e "\e[33m\e[1m==> \e[39m\e[1mMedidas de segurança\e[0m"
	sudo rm -dR {.vimrc,instalador.sh,compton,dunst,gtk-3.0,i3,neofetch,polybar,ranger,rofi,scripts,termite,themes,wallpaper}
...
echo -e "\e[33m\e[1m==> \e[39m\e[1mCopiando arquivos\e[0m"
	...
	cp -r $HOME/.config/{instalador.sh,compton,dunst,gtk-3.0,i3,neofetch,polybar,ranger,rofi,scripts,termite,wallpaper} $HOME/GitHub/i3-dex/config
